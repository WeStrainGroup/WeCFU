...
pinned: false
license: mit
short_description: Friendly web colony counter for petri-dish photos
---

# WeCFU

A friendly, interactive, browser-based colony counter for petri-dish photos.

**Drop images in → auto-count → click to fix → export CSV.**
